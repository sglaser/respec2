                        ...
                        if (b === f.lsb) {
                            ...
                            if (f.lsb === f.msb) {
                                ...
                                if (f.msb > visibleMSB) {
                                    ...
                                    svg.text(g, leftOf(f.msb) + 2, cellTop - 4,
